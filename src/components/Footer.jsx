      ...
      <div className="bg-oasis text-white pt-10">
        <div className="container mx-auto max-w-[1200px] px-4 grid md:grid-cols-3 gap-8">
          <div>
            ...
            <p className="opacity-90 mt-2">+212 667 815 538 • colbail2016@gmail.com</p>
            {/* Social icons */}
            <div className="mt-4 flex gap-4 text-xl opacity-90 justify-en">
              ...
              <a
                href="https://www.instagram.com/ghaliriadspa/"
                target="_blank"
                rel="noopener noreferrer"
              ...
              <a
                href="https://www.facebook.com/ghaliriadspa"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="Facebook"
                className="hover:text-white"
          ...
          <div>
            ...
            <ul className="space-y-2 opacity-90">
              ...
              <li><a href="mailto:colbail2016@gmail.com" className="hover:underline">colbail2016@gmail.com</a></li>
